...
namespace Themes
{
	...
	static void Modern() {
		...
		colors[ImGuiCol_WindowBg] = ImVec4(0.14f, 0.0784f, 0.1375f, 1.00f);
		colors[ImGuiCol_Border] = ImVec4(0.5f, 0.1215f, 0.1215f, 1.0f);
		colors[ImGuiCol_FrameBg] = ImVec4(0.388f, 0.094f, 0.13725f, 1.00f);
		colors[ImGuiCol_TitleBg] = ImVec4(0.388f, 0.094f, 0.13725f, 1.00f);
		colors[ImGuiCol_TitleBgActive] = ImVec4(0.388f, 0.094f, 0.13725f, 1.00f);
		colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.388f, 0.094f, 0.13725f, 1.00f);
		colors[ImGuiCol_MenuBarBg] = ImVec4(0.388f, 0.094f, 0.13725f, 1.00f);
		...
		colors[ImGuiCol_Button] = ImVec4(0.208f, 0.2f, 0.282f, 1.f);
		colors[ImGuiCol_ButtonHovered] = ImVec4(0.175f, 0.2f, 0.3f, 1.f);
		colors[ImGuiCol_ButtonActive] = ImVec4(0.225f, 0.22f, 0.3f, 1.f);
		colors[ImGuiCol_Header] = ImVec4(0.20f, 0.20f, 0.20f, 0.80f);
		colors[ImGuiCol_HeaderHovered] = ImVec4(0.30f, 0.30f, 0.30f, 0.80f);
		colors[ImGuiCol_HeaderActive] = ImVec4(0.40f, 0.40f, 0.40f, 0.80f);
		colors[ImGuiCol_ResizeGrip] = ImVec4(0.20f, 0.20f, 0.20f, 0.65f);
		colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.30f, 0.30f, 0.30f, 0.70f);
		colors[ImGuiCol_ResizeGripActive] = ImVec4(0.40f, 0.40f, 0.40f, 0.75f);
		colors[ImGuiCol_PlotLines] = ImVec4(0.63f, 0.63f, 0.63f, 1.00f);
		colors[ImGuiCol_PlotLinesHovered] = ImVec4(0.78f, 0.78f, 0.78f, 1.00f);
		colors[ImGuiCol_PlotHistogram] = ImVec4(0.63f, 0.63f, 0.63f, 1.00f);
		colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.78f, 0.78f, 0.78f, 1.00f);
